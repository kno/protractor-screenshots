...
(function() {
  ...
  browser.getCapabilities().then(function(capabilites) {
...
*/
    browserName = capabilites.get("browserName").toLowerCase();
    platform = capabilites.get("platform").toLowerCase();
    version = capabilites.get("version").toLowerCase();
